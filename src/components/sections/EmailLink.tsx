...
export default function EmailLink({ loopMessage = false }: EmailLinkProps) {
  ...
  const displayMessage =
    reducedMotion || state.message === '' ? localPart : state.message;
  ...
  const emailContent = (
    <>
      ...
      <span className="contact-email-domain">@{domainPart}</span>
    </>
  );
